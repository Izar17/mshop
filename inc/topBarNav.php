...
// Check if user is logged in
              ...
              <li class="nav-item">
                <a href="lianmap/index_nl.php" class="nav-link">Map</a>
              </li>
...
// Check if user is logged in
              if(isset($_SESSION['userdata'])): ?>
                <li class="nav-item">
                  <a href="lianmap" class="nav-link">Map</a>
                </li>
              <li class="nav-item">
                <a href="https://cdn.botpress.cloud/webchat/v2.2/shareable.html?configUrl=https://files.bpcontent.cloud/2024/12/17/02/20241217023232-FGWGRIWU.json" class="nav-link <?= isset($page) && $page =='map' ? "active" : "" ?>">Online Chatbot</a>
              </li>
              <?php endif; ?>
              <li class="nav-item">
